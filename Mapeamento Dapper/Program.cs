...
namespace CursoDeCsharp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            = "data source=ANAC_NOTEBOOK;initial catalog=CursoDeCsharp;trusted_connection=true;Trust Server Certificate=true";
        ...
        static void ExecuteProcedure(SqlConnection connection){
            ...
            var pars = new {StudentId="e6be781d-f131-4739-a64a-0add10bb83bc"};
        ...
        {
            var query = @"select * from Career where [Id] IN('4327ac7e-963b-4893-9f31-9a3b28a4e72b', 'e6730d1c-6870-4df3-ae68-438624e04c72')";
